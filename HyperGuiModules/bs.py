...
class BS:
    ...
    def __update_trans(self, event = None):
        ...
        self.shift_ud = int(self.entry_shift_ud.get())*-1
        self.shift_lr = int(self.entry_shift_lr.get())*-1
        ...
        self.shift_ud_2 = int(self.entry_shift_ud_2.get())*-1
        self.shift_lr_2 = int(self.entry_shift_lr_2.get())*-1
    ...
    def __reset(self):
        self.entry_shift_lr.delete(0,"end")
        self.entry_shift_lr.insert(0, str(0))
        self.entry_shift_ud.delete(0,"end")
        self.entry_shift_ud.insert(0, str(0))
        self.entry_tilt.delete(0,"end")
        self.entry_tilt.insert(END, str(0))
        self.entry_stretch_lr.delete(0,"end")
        self.entry_stretch_lr.insert(0, str(1))
        self.entry_stretch_ud.delete(0,"end")
        self.entry_stretch_ud.insert(0, str(1))
        self.entry_shift_lr_2.delete(0,"end")
        self.entry_shift_lr_2.insert(0, str(0))
        self.entry_shift_ud_2.delete(0,"end")
        self.entry_shift_ud_2.insert(0, str(0))
        self.entry_tilt_2.delete(0,"end")
        self.entry_tilt_2.insert(0, str(0))
        self.entry_stretch_lr_2.delete(0,"end")
        self.entry_stretch_lr_2.insert(0, str(1))
        self.entry_stretch_ud_2.delete(0,"end")
        self.entry_stretch_ud_2.insert(0, str(1))
        self.__update_trans()
...
# ---------------------- MISC ------------------------------------------
    ...
    def __info(self): 
        info = self.listener.modules[INFO].bs_info
